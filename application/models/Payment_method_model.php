...
class Payment_method_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('payment_method', $q);
	$this->db->or_like('payment_method_name', $q);
	$this->db->or_like('description', $q);
	$this->db->or_like('payment_method_stamp', $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2023-02-21 17:34:59 */
/* http://harviacode.com */