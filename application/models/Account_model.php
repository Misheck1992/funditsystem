...
class Account_model extends CI_Model
{
    ...
    function transfer_funds($senderr, $recepientt,$amount, $transid,$paid_date, $proof = NULL){
    ...
    public function cash_transaction($teller_account,$account,$amount,$mode,$transid,$paid_date, $proof=NULL){
    ...
    public  function search($search_code,$search_by,$group){
        ...
        if($group == 'individual'){
            if($search_by =='account'){
                $this->db->select("*,Firstname as name")->from('individual_customers')->join('account','account.client_id=individual_customers.id')->where('account.account_number',$search_code)->join('account_types','account_types.account_type_id=account.account_type');
            ...
            if($search_by =='name'){
                $this->db->select("*,Firstname as name")->from('individual_customers')->join('account','account.client_id=individual_customers.id')->join('account_types','account_types.account_type_id=account.account_type');
            ...
            if($search_by =='account'){
                ...
                $this->db->select("*,group_name as name")->from('groups')->join('account','account.client_id=groups.group_id')->where('account.account_number',$search_code)->join('account_types','account_types.account_type_id=account.account_type');
