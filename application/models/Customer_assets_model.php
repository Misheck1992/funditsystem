...
class Customer_assets_model extends CI_Model
{

    public $table = 'customer_assets';
    public $id = 'customer_asset_id';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('customer_asset_id', $q);
...
/* End of file Customer_assets_model.php */
