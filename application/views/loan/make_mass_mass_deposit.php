<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">All Loan processed </h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                <a class="breadcrumb-item" href="#">-</a>
                <span class="breadcrumb-item active">All loans processed</span>
            </nav>
        </div>
    </div>
    <div class="card">
            ...
            <table  id="data-table" class="tableCss">
                ...
                <tr>
                    ...
                    <th colspan="12">
                        ...
                        <a href="<?php echo base_url('loan/mass_repayments_make_deposits_data')?>" class="btn btn-primary btn-sm btn-block"  onclick="confirm('Are you sure you want to make deposits of all processed loans?')">Make deposits All loans</a>
                    </th>
