						...
						<div class="col-lg-5 border-right">
							<form action="<?php echo base_url('loan/create_act')?>" method="POST" enctype="multipart/form-data">
								<table class="table">
									...
									<tr>
										<td colspan="2">
											<label>Credit details files (e.g. bank statement, loan file, etc)</label>
											...
											<div id="loan_forms">
												<div class="row mb-2">
													...
													<div class="col-md-4">
														<input type="file" name="loan_files[]" class="form-control" required>
													</div>
													<div class="col-md-2">
														<button type="button" class="btn btn-danger" onclick="removeLoanFile(this)">Remove</button>
													</div>
												</div>
											</div>

											<button type="button" class="btn btn-primary mt-2" onclick="addloan_files();">
									...
									<tr>
										<td colspan="2">
											...
											<div id="loan_forms1">
												<div class="row mb-2">
													<div class="col-md-3">
														<input type="text" name="corporate_credit[]" placeholder="Credit" class="form-control" required>
													</div>
													<div class="col-md-3">
														<input type="text" name="corporate_debit[]" placeholder="Debit" class="form-control" required>
													</div>
													<div class="col-md-4">
														<input type="file" name="corporate_loan_files[]" class="form-control" required>
													</div>
													<div class="col-md-2">
														<button type="button" class="btn btn-danger" onclick="removeLoanFile(this)">Remove</button>
													</div>
											...
											<button type="button" class="btn btn-primary mt-2" onclick="addloan_corporate_files();">
												<i class="fa fa-plus"></i> Add more files
											</button>
										</td>
									</tr>
