	...
	<div class="card">
		<div class="card-body" style="border: thick #153505 solid;border-radius: 14px;">
			<div class="row">
				...
				echo anchor(site_url('Loan/update_initiate_close/'.$loan_id),'Close loan','onclick="javasciprt: return confirm(\'Are You Sure you want to request to close the loan ?\')"'); 
?>
                    </td>
                            </tr>
...
<!--						</tr>-->
				...
				<div class="col-lg-2">
                   ...
                   <?php echo anchor(site_url('Loan/update_initiate_close/'.$loan_id),'Close loan','onclick="javasciprt: return confirm(\'Are You Sure you want to request to close the loan ?\')"'); 
?>
