<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Loan Delete Recommendation requests</h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                <a class="breadcrumb-item" href="#">-</a>
                <span class="breadcrumb-item active">All  delete request to recommend</span>
            </nav>
        </div>
    </div>
    <div class="card">
        <div class="card-body" style="border: thick #153505 solid;border-radius: 14px;">
            ...
            <form name="frmrecommend" method="post" action="">
                <table  id="data-table" class="tableCss">
                    ...
                    foreach ($loan_data as $loan)
                    {
                        ...
                        <tr>
                            ...
                            <td width="600px"><a href="<?php echo base_url('loan/view/').$loan->loan_id.'?action=delete_recommend' ?>" class="btn btn-sm btn-warning">View/Recommend Delete</a>
                            </td>
                ...
                <input type="button" name="Approve" value="Recommend all"  class="btn btn-danger"  /> <input type="button" name="Reject" value="Reject" onClick="recommend_reject_all_loans();"  class="btn btn-warning" />
            </form>
        </div>
