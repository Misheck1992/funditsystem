                                    ...
                                    foreach ($trans as $history)
                                    {
                                        ...
                                        ?>
                                              <tr>
                                                  ...
                                                  <td><a class="btn btn-primary" onclick="get_transaction_usage('<?php echo $history->transaction_id; ?>')">Payments breakdown</a>|<a href="" class="btn btn-warning">Reverse transaction</a></td>
                                              </tr>
...
<div aria-hidden="true" class="onboarding-modal modal fade" id="payment_modal_r" role="dialog" tabindex="-1">
            ...
            <div class="onboarding-content" style="padding: 1em;">
                ...
                <form action="<?php echo base_url('loan/pay_loan_r')?>" class="form-row" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group col-lg-12" style="padding: 5em;">
                        <label for="date">Type deposit amount  in <?php echo $currency->currency_code ?> &nbsp; </label>
                        ...
                        <input type="text" name="payment_numberr" value="<?php echo $next_payment_id_rescheduled ?>" hidden>


                        <input style="border: thin red solid;" type="text" class="form-control" name="amount"  value="<?php echo $rd->payment_amount; ?>" placeholder="Enter pay amount"  required />
                        <br/>
                        ...
                        <div class="form-group col-12">
                            ...
                            <select name="payment_method" id="payment_method" class="form-control">
                                ...
                                <option value="0">Instituions' Bank savings</option>
                                <?php
...
<div aria-hidden="true" class="onboarding-modal modal fade" id="advance_payment_modal_r" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg modal-centered" role="document">
        <div class="modal-content text-center">
            <span></span><button style="float: right;" aria-label="Close" class="close" data-dismiss="modal" type="button"><span class="close-label">Close</span><span class="anticon anticon-close"></span></button>
            <div class="onboarding-content" style="padding: 1em;">
                ...
                <form action="<?php echo base_url('loan/pay_advance_r')?>" class="form-row" method="POST" >
                    <table style="width: 100%;border-collapse: collapse;">
                        <thead>
                        <tr style="border: 1px solid black;">
                            <th>Payment #</th>
                        ...
                        if(empty($rep)){
                            ...
                            foreach ($rep as $pp){
                                ...
                                $cssa = '';
                                $xstatusa = '';
                                if($pp->payment_date < date('Y-m-d')   AND $pp->pay_status == 'UNPAID') {
                                    $cssa = ' class="due"';
                                    $xstatusa = ' | OVER DUE';
                                } elseif($pp->pay_status=='PAID') {
                                    $css = 'class="paid"';
                                } elseif($pp->payment_date == date('Y-m-d')  AND $pp->pay_status == 'UNPAID') {
                                    $cssa = ' class="due_now"';
                                    $xstatusa = ' | DUE TODAY';
                                }
                                ?>
                                <!--							<tr style="border: 1px solid black;background-color: #F3D8D8;">-->
                                <tr style="font-weight: <?php echo !empty($xstatus)?'900':'200'; ?>;">
                                    <td <?php echo $cssa; ?>><?php  echo $pp->payment_number?></td>
                                    <td <?php echo $cssa; ?>><?php  echo $pp->payment_date?></td>
                                    <td <?php echo $cssa; ?>><?php echo $currency->currency_code ?> &nbsp;<?php  echo number_format($pp->payment_amount,2) ?></td>
                                    <td <?php echo $cssa; ?>><?php echo $currency->currency_code ?> &nbsp;<?php  echo number_format($pp->paid_amount,2)?></td>

                                    <td width="150" <?php echo $cssa; ?>><span style="color:<?php echo $p->status=='PAID' ? 'GREEN' : 'RED'?>"><?php echo $pp->pay_status.$xstatusa; ?></span></td>
                                    <td <?php echo $cssa; ?> width="70"><?php if($pp->pay_status == 'UNPAID') { ?>  <input type="checkbox" name="payment_number[]" value="<?php echo $pp->payment_number  ?>" class="check-cls"><?php  } ?></td>
                                </tr>
                                <?php
                            }
                        }
                    ...
                    <input style="border: thin red solid;" type="text" class="form-control" name="amount"  value="<?php echo $pp->payment_amount?>" hidden />
