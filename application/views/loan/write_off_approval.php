<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Loans write off requests</h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                <a class="breadcrumb-item" href="#">-</a>
                <span class="breadcrumb-item active">All loans write off requests</span>
            </nav>
        </div>
    </div>
    <div class="card">
                ...
                foreach ($loan_data as $loan)
                {
                    ...
                    <tr>
                        ...
                        <td width="250">
                            ...
                            ?>
                            <a class="btn btn-sm btn-danger" href="<?php echo base_url('loan/write_action?id=').$loan->loan_id."&action=WRITTEN_OFF" ?>" onclick="return confirm('Are you sure you want to  approve write off  of  this loan?')">Write off  approve</a>
