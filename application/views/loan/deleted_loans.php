<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Deleted Loans</h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                <a class="breadcrumb-item" href="#">-</a>
                <span class="breadcrumb-item active">All  deleted loans</span>
            </nav>
        </div>
    </div>
    <div class="card">
                ...
                <table  id="data-table" class="tableCss">
                    ...
                    foreach ($loan_data as $loan)
                    {
                        ...
                        <tr>
                            ...
                            <td width="600px">
                                <a href="<?php echo base_url('loan/view/').$loan->loan_id ?>" class="btn btn-sm btn-secondary">View details</a>
                                             </td>
