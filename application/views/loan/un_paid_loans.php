    ...
    <div class="card">
        <div class="card-body" style="border: thick #153505 solid;border-radius: 14px;">
            <div>
                ...
                ?>
                <form action="<?php echo base_url('loan/un_paid_loans') ?>" method="get">
...
//                        ?>
<!--                    </select> -->
Status: <select name="status" id="" class="select2">
                        <option value="All">All statuses</option>
                        <option value="fully_unpaid">Fully unpaid</option>

                    </select>
                    <input type="submit" value="filter" name="search"><input type="button" value="export excel" id="exportTableUnpaidloans" name="search">
                </form>
            </div>
            <br>
            <hr>
            ...
            <table  id="data-table" class="tableCss">
                ...
                foreach ($loan_data as $loan)
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo $loan->customer_type ?></td>
                        <td><?php

                            $produlp = $this->Loan_products_model->get_by_id($loan->loan_product);

                            echo  $produlp->product_name ?></td>
