            ...
            <table  id="data-table" class="tableCss">
                ...
                <tr>
                    ...
                    <th colspan="12">
                        ...
                        <a href="<?php echo base_url('loan/mass_repayments_make_payments_data')?>" class="btn btn-primary btn-sm btn-block"  onclick="confirm('Are you sure you want to make payments of all processed loans?')">Make payments All loans</a>
                    </th>
