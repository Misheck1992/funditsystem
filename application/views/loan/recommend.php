<div class="main-content">
    ...
    <div class="card">
        <div class="card-body" style="border: thick #153505 solid;border-radius: 14px;">
            ...
            <input type="button" name="Approve" value="Recommend all" onClick="recommend_prompt();" class="btn btn-danger"  /> <input type="button" name="Reject" value="Reject" onClick="recommend_reject_all_loans();"  class="btn btn-warning" />
            </form>
        </div>
