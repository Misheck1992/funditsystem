...
<div class="main-content">
	<div class="page-header">
		<h2 class="header-title">Obligor Listing Report</h2>
		<div class="header-sub-title">
			<nav class="breadcrumb breadcrumb-dash">
				<a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
				<a class="breadcrumb-item" href="#">Reports</a>
				<span class="breadcrumb-item active">Obligor Listing</span>
			</nav>
		</div>
	</div>
	<div class="card">
		<div class="card-body" style="border: thick #153505 solid;border-radius: 14px;">
			<form action="<?php echo base_url('reports/obligor_listing') ?>" method="get">
				<fieldset>
					...
					<div id="controlgroup" style="margin-bottom: 15px;">
						...
						<a href="<?php echo base_url('reports/obligor_listing')?>" class="btn btn-sm btn-secondary">Reset Filters</a>
					</div>
				</fieldset>
			</form>
			<hr>
			<p>Obligor Listing Report - Total Records: <?php echo count($loan_data); ?></p>
