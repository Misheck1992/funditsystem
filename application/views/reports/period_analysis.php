	...
	<div class="card">
		<div class="card-body" style="border: thick #153505 solid;border-radius: 14px;">
			...
			<table class="table table-bordered">
				...
				<tr>
					<td>(c)Total Number of  client in book at last day of reporting period</td>
					<td style="text-align: left;"><?php
						echo $customers;
						?></td>
				</tr>
				<tr>
					<td>(d) Total Number of  Employees on last day of reporting period</td>
					<td style="text-align: left;"><?php echo $employees?></td>
				</tr>
				<tr>
					<td>(e) Total Number of  agents and brokers (If any)</td>
					<td style="text-align: left;">0</td>
				</tr>
				<tr>
					<td>(e) Total Number of people employed by  agents and brokers (If any)</td>
					<td style="text-align: left;">0</td>
				</tr>
			</table>
		</div>
