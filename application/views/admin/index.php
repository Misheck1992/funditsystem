...
<div class="main-content">
    ...
    ?>
        <div class="row">
            <div class="col-lg-12">
                <h2 class="heading">Admin Dashboard Stats</h2>
                <hr class="dash" >
            </div>
        </div>
        <div class="row">
                ...
                <a class="dashboard-stat hoki" href="#">
                    ...
                    <div class="details">
                        ...
                        <span><?php echo $settings->currency?> <?php
                            ...
                            $ipc = get_total_loan_amount('closed');
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="heading">Product Portfolio (Total amount Initiated ,Disbursed,Closed)</h2>
                <hr class="dash" >
            </div>
        </div>
...
//            $product->loan_product_id
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <a class="dashboard-stat green" href="<?php echo base_url('loan/loan_product_summary/'). urlencode($product->loan_product_id);?>">
                        <div class="visual">
                            <i class="fa fa-usd"></i>
                        </div>
                        <div class="details">
                        ...
                        <span><?php echo $settings->currency ?><?php
                            $bproduct=0;
                            if (!empty($bproduct) && isset($bproduct->total_amount_product)) {
                                echo number_format((float) $bproduct->total_amount_product, 2);
                            } else {
                                echo number_format(0, 2); // Default to 0.00 if null
                            }


                            ?></span>
                            </div>
                            <div class="desc"><?php echo $product->product_name; ?></div>
                        </div>
                    </a>
                </div>
                <?php
