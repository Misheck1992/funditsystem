                ...
                foreach ($shareholders_data as $shareholder) {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center" width="300px">
                            <a href="<?php echo base_url('shareholders/approval_action/'.$shareholder->id)?>" class="btn btn-success" onclick="return confirm('Are you sure you want to approve this shareholder?')">
                                <i class="os-icon os-icon-check"></i>Approve
                            </a>
                            <a href="<?php echo base_url('shareholders/reject_action/'.$shareholder->id)?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to reject this shareholder?')">
