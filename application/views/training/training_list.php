...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $training->trainings_id ?></td>
			<td><?php echo $training->training ?></td>
			<td><?php echo $training->customer ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('training/read/'.$training->),'Read'); 
				echo ' | '; 
				echo anchor(site_url('training/update/'.$training->),'Update'); 
				echo ' | '; 
				echo anchor(site_url('training/delete/'.$training->),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
