	...
	<th>#</th>
		...
		$n = 1;
			...
			<td style="text-align:center" width="200px">
                <a href="<?php echo base_url('employees/read/'.$employees->empid) ;?>" class="btn  btn-info">View</a>
                <a href="<?php echo base_url('employees/update/'.$employees->empid) ;?>" class="btn  btn-warning">Edit</a>
                <a href="<?php echo base_url('employees/delete/'.$employees->empid) ;?>" class="btn  btn-danger">Delete</a>
