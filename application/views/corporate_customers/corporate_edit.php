...
// Get existing shareholders for this corporate customer
$existing_shareholders = get_all_shareholders($id);
?>
    ...
    <div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <span class="breadcrumb-item active">Edit Corporate Customer</span>
            </nav>
        </div>
    </div>
    <div class="card">
                ...
                <div class="row">
                        ...
                        <div class="shareholder-container form-row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <select class="form-control" name="entity_type" id="entity_type" required>
                                    ...
                                    <option value="Sole Proprietorship" <?php echo ($entity_type == 'Sole Proprietorship') ? 'selected' : ''; ?>>Sole Proprietorship</option>
                                    <option value="Partnership" <?php echo ($entity_type == 'Partnership') ? 'selected' : ''; ?>>Partnership</option>
                                    <option value="Limited Company" <?php echo ($entity_type == 'Limited Company') ? 'selected' : ''; ?>>Limited Company</option>
                                    <option value="Government Entity" <?php echo ($entity_type == 'Government Entity') ? 'selected' : ''; ?>>Government Entity</option>
                                    <option value="Non Government Entity" <?php echo ($entity_type == 'Non Government Entity') ? 'selected' : ''; ?>>Non Government Entity</option>
                                </select>
                            </div>
                            <div class="form-group col-6">
                            ...
                            <!-- Financial Year End and Employee Count Fields -->
                            <div class="form-group col-6">
                            ...
                            <div class="form-group col-3">
                                <label for="casual_employees">Casual Employees</label>
                                <input type="number" class="form-control" name="casual_employees" id="casual_employees" min="0" value="<?php echo isset($casual_employees) ? $casual_employees : '0'; ?>" />
                            </div>
                            <div class="form-group col-3">
                                <label for="permanent_employees">Permanent Employees</label>
                                <input type="number" class="form-control" name="permanent_employees" id="permanent_employees" min="0" value="<?php echo isset($permanent_employees) ? $permanent_employees : '0'; ?>" />
                            </div>
                            ...
                            <div class="form-group col-4">
                                ...
                                <?php if (!empty($company_certificate)): ?>
                                    <small class="text-muted">Current file: <?php echo basename($company_certificate); ?></small>
                                <?php endif; ?>
                            </div>
                            <div class="form-group col-4">
                                <br>
                                ...
                                <?php if (!empty($proof_physical_address)): ?>
                                    <small class="text-muted">Current file: <?php echo basename($proof_physical_address); ?></small>
                                <?php endif; ?>
                            </div>
                            <div class="form-group col-4">
                                <br>
                                ...
                                <?php if (!empty($financial_statement)): ?>
                                    <small class="text-muted">Current file: <?php echo basename($financial_statement); ?></small>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div id="shareholdersTable">
                            <?php if (!empty($existing_shareholders)): ?>
                                <?php foreach ($existing_shareholders as $index => $shareholder): ?>
                                    <div class="shareholder-container">
                                        <div class="shareholder-title">Shareholder #<?php echo $index + 1; ?></div>
                                        <input type="hidden" name="shareholder_id[]" value="<?php echo $shareholder->id; ?>">
                                        <table>
                                            <tr>
                                                <td>Title *</td>
                                                <td><select class="form-control" name="title[]" required>
                                                        <option value="">--select--</option>
                                                        <option value="Mr" <?php echo ($shareholder->title == 'Mr') ? 'selected' : ''; ?>>Mr</option>
                                                        <option value="Mrs" <?php echo ($shareholder->title == 'Mrs') ? 'selected' : ''; ?>>Mrs</option>
                                                        <option value="Miss" <?php echo ($shareholder->title == 'Miss') ? 'selected' : ''; ?>>Miss</option>
                                                        <option value="Dr" <?php echo ($shareholder->title == 'Dr') ? 'selected' : ''; ?>>Dr</option>
                                                        <option value="Prof" <?php echo ($shareholder->title == 'Prof') ? 'selected' : ''; ?>>Prof</option>
                                                        <option value="Rev" <?php echo ($shareholder->title == 'Rev') ? 'selected' : ''; ?>>Rev</option>
                                                        <option value="Bishop" <?php echo ($shareholder->title == 'Bishop') ? 'selected' : ''; ?>>Bishop</option>
                                                        <option value="Other" <?php echo ($shareholder->title == 'Other') ? 'selected' : ''; ?>>Other</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>First Name *</td>
                                                <td><input type="text" class="form-control" name="first_name[]" value="<?php echo $shareholder->first_name; ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td>Last Name *</td>
                                                <td><input type="text" class="form-control" name="last_name[]" value="<?php echo $shareholder->last_name; ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td>Gender *</td>
                                                <td>
                                                    <select class="form-control" name="gender[]" >
                                                        <option value="">--select--</option>
                                                        <option value="male" <?php echo ($shareholder->gender == 'male') ? 'selected' : ''; ?>>Male</option>
                                                        <option value="female" <?php echo ($shareholder->gender == 'female') ? 'selected' : ''; ?>>Female</option>
                                                    </select>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <select class="form-control select2" type="text" name="nationality[]" required>
                                                        ...
                                                        foreach ($countryd as $c){
                                                            ?>
                                                            <option value="<?php echo $c->code; ?>" <?php echo ($shareholder->nationality == $c->code) ? 'selected' : ''; ?>><?php echo $c->name; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <tr>
                                                <td>Phone Number *</td>
                                                <td><input class="form-control" type="text" name="phone_number[]" value="<?php echo $shareholder->phone_number; ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td>Email Address *</td>
                                                <td><input class="form-control" type="email" name="email_address[]" value="<?php echo $shareholder->email_address; ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td>Full Address </td>
                                                <td><textarea class="form-control" type="text" name="full_address[]" ><?php echo $shareholder->full_address; ?></textarea></td>
                                            </tr>
                                            <tr>
                                                <td>ID Type *</td>
                                                <td>
                                                    <select class="form-control" name="idtype[]" required>
                                                        <option value="NATIONAL_IDENTITY_CARD" <?php echo ($shareholder->idtype == 'NATIONAL_IDENTITY_CARD') ? 'selected' : ''; ?>>National ID</option>
                                                        <option value="PASSPORT" <?php echo ($shareholder->idtype == 'PASSPORT') ? 'selected' : ''; ?>>Passport</option>
                                                        <option value="WORK_PERMIT" <?php echo ($shareholder->idtype == 'WORK_PERMIT') ? 'selected' : ''; ?>>Work Permit</option>
                                                        <option value="DRIVER_LICENSE" <?php echo ($shareholder->idtype == 'DRIVER_LICENSE') ? 'selected' : ''; ?>>Driver's License</option>
                                                        <option value="NONE" <?php echo ($shareholder->idtype == 'NONE') ? 'selected' : ''; ?>>None</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Identity Number *</td>
                                                <td><input class="form-control" type="text" name="idnumber[]" value="<?php echo isset($shareholder->idnumber) ? $shareholder->idnumber : ''; ?>" placeholder="Enter ID number" required></td>
                                            </tr>
                                            <tr>
                                                <td>ID File <span class="text-muted">(Optional)</span></td>
                                                <td>
                                                    <input class="form-control" style="display: block !important;"  type="file" name="idfile[]">
                                                    <?php if (!empty($shareholder->idfile)): ?>
                                                        <small class="text-muted">Current file: <?php echo basename($shareholder->idfile); ?></small>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Ownership share value (%) *</td>
                                                <td><input class="form-control" style="display: block !important;"  type="number" name="percentage_value[]" value="<?php echo $shareholder->percentage_value; ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td><button type="button" class="removeRow btn btn-danger btn-sm">Remove Shareholder</button></td>
                                            </tr>
                                        </table>
                                    </div>
                                <?php endforeach; ?>
