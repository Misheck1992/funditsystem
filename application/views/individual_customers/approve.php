    ...
    <label for="cc">Check All</label></th>
		...
		<th>Action</th>
            ...
            foreach ($individual_customers_data as $individual_customers)
            {
                ?>
                <tr>
                    <td><input type="checkbox" name="users[]" value="<?php  echo $individual_customers->id ?>"> </td>
            ...
            ?>
                ...
                <input type="button" name="Approve" value="approve" onClick="approve_all();" class="btn btn-danger"  /> <input type="button" name="Reject"
                                                              value="Reject" onClick="reject();"  class="btn btn-warning" />
            </form>
		</div>
	</div>
</div>
