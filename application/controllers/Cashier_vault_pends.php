...
class Cashier_vault_pends extends CI_Controller
{
    ...
    public function acceptance(){
    	$result['data']= $this->Cashier_vault_pends_model->get_my_cash($this->session->userdata('user_id'));
		$this->template->set('title', 'Core Banking |Vault to cashier acceptance');
		$this->template->load('template', 'contents' ,'cashier_vault_pends/acceptance',$result);
	}
